...
import { Exercise, ExerciseTracker, FormModal, Stopwatch } from "app/types";
...
export const RepsModal = ({ stopwatch, exerciseTracker, formModal }: Props) => {
  const {
    selectedExercise,
    savedReps,
    setSavedReps,
  ...
  const { fieldValue, setFieldValue, setModalOpen, modalOpen } = formModal;
